    ...
    return (
      <div className='content'>
        <span className='homeTitle'>
          &lt;백문이 불여일견&gt; 블록체인에 한발 다가가기<br/>
          <p>
            2018년 지방선거 투표 인증하고,<br/>
            암호화화폐 지갑에 영원히 존재 하는 기념 토큰을 수집하세요!<br/>
            나의 활동이 토큰화 되어, 불록체인상에 영원히 기록됩니다.
          </p>
        </span>
        <div className='left'>
          <ol>
            ...
            <p>
              <span className='bu'>"블록체인 & 암호화화폐 꼭 금전적인 가치가 함께여야만 할까요?"</span><br />
            ...
            <p>
              <span className='bu'>"서로에게 몇 배 오를 ICO 추천이 아닌, 블록체인에 대한 이야기를 해보면 어떨까요?"</span><br />
            ...
            <p>
              <span className='bu'>"블록체인에 관심을 갖게 된 분들을 위해 도와주세요! 모두의 추억이 기록될 수 있도록"</span><br />
              ...
              (후원금을 절대 개인이 사용하지 않습니다. 후원금이 조금이라도 남는다면 다음 기념 토큰의 Transaction 수수료를 위해 사용될 것 입니다.)<br/>
              <span className='red-text'>후원 주소: 0xE484C512c156C7F30C85CF432b8E2E70Fd499058</span>
            </p>
          </ol>
        </div>
        <span className='bpXyull'>
          <span className='BP'>BP</span> Crew X <br /><span className='YULL'>YULL</span> STUDIO</span>
      </div>
    );
  }
}
